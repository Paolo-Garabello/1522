...
<Tile
	title="Crediti"
	text={[
		'Questo sito è stato creato da Paolo Garabello per la sensibilizzazione contro vioenza sulle donne',
		'Il progetto è frutto di un compito scolastico di educazione civica al fine di creare qualcosa di concreto unendo le conoscenze di indirizzo con un percorso contro la violenza di genere',
		'Per ulteriori dettagli visita il sito ufficiale del 1522'
	]}
	id={"Crediti"}
/>
